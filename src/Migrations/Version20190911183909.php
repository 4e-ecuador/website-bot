...
final class Version20190911183909 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE SEQUENCE agent_stat_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
        $this->addSql('CREATE TABLE agent_stat (id INT NOT NULL, agent_id_id INT NOT NULL, datetime TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, ap INT NOT NULL, explorer INT NOT NULL, recon INT NOT NULL, PRIMARY KEY(id))');
