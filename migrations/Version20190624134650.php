...
final class Version20190624134650 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(
            'CREATE SEQUENCE faction_id_seq INCREMENT BY 1 MINVALUE 1 START 1'
        );
        $this->addSql(
            'CREATE TABLE faction (id INT NOT NULL, name VARCHAR(255) NOT NULL, PRIMARY KEY(id))'
        );
        $this->addSql('ALTER TABLE agent ADD faction_id INT NOT NULL');
        $this->addSql(
            'ALTER TABLE agent ADD CONSTRAINT FK_268B9C9D4448F8DA FOREIGN KEY (faction_id) REFERENCES faction (id) NOT DEFERRABLE INITIALLY IMMEDIATE'
        );
        $this->addSql(
            'CREATE INDEX IDX_268B9C9D4448F8DA ON agent (faction_id)'
        );
    }
