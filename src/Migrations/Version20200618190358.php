...
final class Version20200618190358 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(
            'CREATE UNIQUE INDEX UNIQ_20086CAAE7927C74 ON agent_user (email)'
        );
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql(
            'ALTER TABLE agent_user ADD username VARCHAR(180) NOT NULL'
        );
        $this->addSql(
            'ALTER TABLE agent_user ADD password VARCHAR(255) DEFAULT NULL'
        );
