...
final class Version20200604044156 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE agent ADD telegram_connection_secret VARCHAR(48) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE config (id INT NOT NULL, encryption_key BYTEA NOT NULL, encryption_key_encoded TEXT NOT NULL, PRIMARY KEY(id))');
